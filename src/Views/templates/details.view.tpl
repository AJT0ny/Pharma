<div class="hero-shop set-bg-shop" style="background-image: url('public/imgs/pharma/farmacia.png');">
    <div class="hero_text">
        <h2 class="display-2 text-white ">DETAILS</h2>
        <p>Mira los detalles de los productos</p>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">Precio</div>
                        ...
                        <ul>
                            <li><b>Disponibilidad</b> <span>En existencia</span></li>
